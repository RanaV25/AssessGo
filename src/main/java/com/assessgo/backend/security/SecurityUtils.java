...
public final class SecurityUtils {
    ...
    public static boolean isUserHasRole(final String role) {
        Authentication userAuthentication = SecurityContextHolder.getContext().getAuthentication();
        // All other views require authentication
        if (!isUserLoggedIn(userAuthentication)) {
            return false;
        ...
        boolean isRoleFound = userAuthentication.getAuthorities()
                .stream()
                .filter(grantedAuthority -> ((GrantedAuthority) grantedAuthority).getAuthority().equals(role))
                .findAny().isPresent();
